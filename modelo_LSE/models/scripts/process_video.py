...
def process_video(input_path, target_fps=12):
    """
    Procesa el video ubicado en input_path, ajustando su tamaño y tasa de frames.

    Args:
        input_path (str): Ruta del video de entrada.
        target_fps (int): Tasa de frames objetivo.
    ...
    if not os.path.isfile(input_path):
        print("Error: El archivo de entrada no existe o no es un archivo válido.")
        return None
